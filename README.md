...
3.  **View your dashboard:** After the tweets are generated, you can view them on your dashboard at [http://localhost:3000/dashboard](http://localhost:3000/dashboard).
